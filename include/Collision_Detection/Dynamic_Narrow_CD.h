...
namespace LPhys
{
	...
	private:
        ...
        Intersection_Data collision__moving_vs_static(const Physics_Module_2D& _moving, const Physics_Module_2D& _static) const;

        LEti::Geometry::Simple_Intersection_Data collision__static_vs_point(const Physics_Module_2D& _static, const glm::vec3& _point) const;
