...
private:
    ...
    Intersection_Data intersection__polygon_vs_segment(const Polygon& _polygon, const LEti::Geometry::Segment& _segment) const;
    Intersection_Data intersection__polygon_vs_polygon(const Polygon& _first, const Polygon& _second) const;

    Intersection_Data collision__model_vs_segment(const Physical_Model_2D& _model, const LEti::Geometry::Segment& _segment) const;
